...
public class KreyniumPlatePRBProcedure extends SaModElements.ModElement {
	public KreyniumPlatePRBProcedure(SaModElements instance) {
		super(instance, 107);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SaMod.LOGGER.warn("Failed to load dependency entity for procedure KreyniumPlatePRB!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				SaMod.LOGGER.warn("Failed to load dependency itemstack for procedure KreyniumPlatePRB!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		ItemStack itemstack = (ItemStack) dependencies.get("itemstack");
		if ((((entity.getCapability(SaModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new SaModVariables.PlayerVariables())).pageNumber) == 2)) {
			{
				String _setval = (String) (new TranslationTextComponent("Kreynium Panel").getString());
			...
			}
			{
				...
				final ItemStack _setstack = new ItemStack(PolishedKreyniumIngotItem.block, (int) (1));
