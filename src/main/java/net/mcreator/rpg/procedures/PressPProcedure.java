...
public class PressPProcedure extends SaModElements.ModElement {
	public PressPProcedure(SaModElements instance) {
		super(instance, 76);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SaMod.LOGGER.warn("Failed to load dependency entity for procedure PressP!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				SaMod.LOGGER.warn("Failed to load dependency x for procedure PressP!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				SaMod.LOGGER.warn("Failed to load dependency y for procedure PressP!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				SaMod.LOGGER.warn("Failed to load dependency z for procedure PressP!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				SaMod.LOGGER.warn("Failed to load dependency world for procedure PressP!");
			return;
		}
				...
				if ((((new Object() {
					...
					if (((new Object() {
						...
						if (!world.isRemote()) {
							...
							BlockState _bs = world.getBlockState(_bp);
							if (_tileEntity != null)
								_tileEntity.getTileData().putDouble("maxFuel", 0);
							if (world instanceof World)
								((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
						}
					}
