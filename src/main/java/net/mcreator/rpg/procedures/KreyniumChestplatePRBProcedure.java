...
public class KreyniumChestplatePRBProcedure extends SaModElements.ModElement {
	public KreyniumChestplatePRBProcedure(SaModElements instance) {
		super(instance, 110);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SaMod.LOGGER.warn("Failed to load dependency entity for procedure KreyniumChestplatePRB!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				SaMod.LOGGER.warn("Failed to load dependency itemstack for procedure KreyniumChestplatePRB!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		ItemStack itemstack = (ItemStack) dependencies.get("itemstack");
		if ((((entity.getCapability(SaModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new SaModVariables.PlayerVariables())).pageNumber) == 5)) {
			{
				String _setval = (String) (new TranslationTextComponent("Kreynium Chestplate").getString());
			...
			}
			{
				...
				final ItemStack _setstack = new ItemStack(Items.DIAMOND_CHESTPLATE, (int) (1));
			...
			{
				ItemStack _isc = (itemstack);
				final ItemStack _setstack = new ItemStack(KreyniumArmorItem.body, (int) (1));
