...
public class PressRecipeBookNextPageProcedure extends SaModElements.ModElement {
	public PressRecipeBookNextPageProcedure(SaModElements instance) {
		super(instance, 103);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SaMod.LOGGER.warn("Failed to load dependency entity for procedure PressRecipeBookNextPage!");
			return;
		}
