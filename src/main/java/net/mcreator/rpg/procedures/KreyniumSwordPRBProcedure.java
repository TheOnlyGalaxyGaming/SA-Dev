...
public class KreyniumSwordPRBProcedure extends SaModElements.ModElement {
	public KreyniumSwordPRBProcedure(SaModElements instance) {
		super(instance, 135);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SaMod.LOGGER.warn("Failed to load dependency entity for procedure KreyniumSwordPRB!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				SaMod.LOGGER.warn("Failed to load dependency itemstack for procedure KreyniumSwordPRB!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		ItemStack itemstack = (ItemStack) dependencies.get("itemstack");
		if ((((entity.getCapability(SaModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new SaModVariables.PlayerVariables())).pageNumber) == 8)) {
			{
				String _setval = (String) (new TranslationTextComponent("Kreynium Sword").getString());
			...
			{
				ItemStack _isc = (itemstack);
				final ItemStack _setstack = new ItemStack(KreyniummSwordItem.block, (int) (1));
