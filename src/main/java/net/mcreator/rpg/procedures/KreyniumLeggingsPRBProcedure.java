...
public class KreyniumLeggingsPRBProcedure extends SaModElements.ModElement {
	public KreyniumLeggingsPRBProcedure(SaModElements instance) {
		super(instance, 111);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SaMod.LOGGER.warn("Failed to load dependency entity for procedure KreyniumLeggingsPRB!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				SaMod.LOGGER.warn("Failed to load dependency itemstack for procedure KreyniumLeggingsPRB!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		ItemStack itemstack = (ItemStack) dependencies.get("itemstack");
		if ((((entity.getCapability(SaModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new SaModVariables.PlayerVariables())).pageNumber) == 6)) {
			{
				String _setval = (String) (new TranslationTextComponent("Kreynium Leggings").getString());
			...
			}
			{
				...
				final ItemStack _setstack = new ItemStack(Items.DIAMOND_LEGGINGS, (int) (1));
			...
			{
				ItemStack _isc = (itemstack);
				final ItemStack _setstack = new ItemStack(KreyniumArmorItem.legs, (int) (1));
