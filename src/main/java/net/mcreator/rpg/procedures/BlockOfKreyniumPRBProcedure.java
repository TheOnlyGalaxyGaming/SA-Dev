...
public class BlockOfKreyniumPRBProcedure extends SaModElements.ModElement {
	public BlockOfKreyniumPRBProcedure(SaModElements instance) {
		super(instance, 108);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SaMod.LOGGER.warn("Failed to load dependency entity for procedure BlockOfKreyniumPRB!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				SaMod.LOGGER.warn("Failed to load dependency itemstack for procedure BlockOfKreyniumPRB!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		ItemStack itemstack = (ItemStack) dependencies.get("itemstack");
		if ((((entity.getCapability(SaModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new SaModVariables.PlayerVariables())).pageNumber) == 3)) {
			{
				String _setval = (String) (new TranslationTextComponent("Block Of Kreynium").getString());
			...
			{
				ItemStack _isc = (itemstack);
				final ItemStack _setstack = new ItemStack(BlockOfKreyniumBlock.block, (int) (1));
