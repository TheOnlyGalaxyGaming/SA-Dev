...
public class KreyniumShovelPRBProcedure extends SaModElements.ModElement {
	public KreyniumShovelPRBProcedure(SaModElements instance) {
		super(instance, 138);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SaMod.LOGGER.warn("Failed to load dependency entity for procedure KreyniumShovelPRB!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				SaMod.LOGGER.warn("Failed to load dependency itemstack for procedure KreyniumShovelPRB!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		ItemStack itemstack = (ItemStack) dependencies.get("itemstack");
		if ((((entity.getCapability(SaModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new SaModVariables.PlayerVariables())).pageNumber) == 11)) {
			{
				String _setval = (String) (new TranslationTextComponent("Kreynium Shovel").getString());
			...
			}
			{
				...
				final ItemStack _setstack = new ItemStack(Items.DIAMOND_SHOVEL, (int) (1));
			...
			{
				ItemStack _isc = (itemstack);
				final ItemStack _setstack = new ItemStack(KreyniummShovelItem.block, (int) (1));
