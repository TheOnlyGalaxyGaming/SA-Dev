...
import net.mcreator.rpg.gui.WaterTankGUIGui;
...
public class WaterTankBlock extends SaModElements.ModElement {
	@ObjectHolder("sa:water_tank")
	public static final Block block = null;
	@ObjectHolder("sa:water_tank")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public WaterTankBlock(SaModElements instance) {
		super(instance, 8);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("water_tank"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Water Tank");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new WaterTankGUIGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("water_tank");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new WaterTankGUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
		...
		private final FluidTank fluidTank = new FluidTank(80000) {
			@Override
