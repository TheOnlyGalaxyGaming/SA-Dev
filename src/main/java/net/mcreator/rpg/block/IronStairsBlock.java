...
public class IronStairsBlock extends SaModElements.ModElement {
	@ObjectHolder("sa:iron_stairs")
	public static final Block block = null;
	public IronStairsBlock(SaModElements instance) {
		super(instance, 44);
	}
