...
public class FluidTankBlock extends SaModElements.ModElement {
	@ObjectHolder("sa:fluid_tank")
	public static final Block block = null;
	@ObjectHolder("sa:fluid_tank")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public FluidTankBlock(SaModElements instance) {
		super(instance, 9);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2.5f, 20f).setLightLevel(s -> 0));
