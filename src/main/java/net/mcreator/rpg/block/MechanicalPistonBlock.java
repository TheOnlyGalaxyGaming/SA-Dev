...
public class MechanicalPistonBlock extends SaModElements.ModElement {
	@ObjectHolder("sa:mechanical_piston")
	public static final Block block = null;
	public MechanicalPistonBlock(SaModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1.5f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("mechanical_piston");
		}
