...
import net.mcreator.rpg.gui.DistilationChamberGUIGui;
...
public class DistilationChamberBlock extends SaModElements.ModElement {
	@ObjectHolder("sa:distilation_chamber")
	public static final Block block = null;
	@ObjectHolder("sa:distilation_chamber")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public DistilationChamberBlock(SaModElements instance) {
		super(instance, 146);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("distilation_chamber"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("distilation_chamber");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Distilation Chamber");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new DistilationChamberGUIGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("distilation_chamber");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new DistilationChamberGUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
