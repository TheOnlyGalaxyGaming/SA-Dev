...
public class SlicedTomatoItem extends SaModElements.ModElement {
	@ObjectHolder("sa:sliced_tomato")
	public static final Item block = null;
	public SlicedTomatoItem(SaModElements instance) {
		super(instance, 38);
	}
