...
public class HammerItem extends SaModElements.ModElement {
	@ObjectHolder("sa:hammer")
	public static final Item block = null;
	public HammerItem(SaModElements instance) {
		super(instance, 20);
	}
	...
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(SAItemsItemGroup.tab).maxDamage(100));
		}
