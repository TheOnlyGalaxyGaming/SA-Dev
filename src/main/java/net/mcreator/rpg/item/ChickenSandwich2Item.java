...
public class ChickenSandwich2Item extends SaModElements.ModElement {
	@ObjectHolder("sa:chicken_sandwich_2")
	public static final Item block = null;
	public ChickenSandwich2Item(SaModElements instance) {
		super(instance, 29);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("chicken_sandwich_2");
		}
