...
public class ChickenSandwich8Item extends SaModElements.ModElement {
	@ObjectHolder("sa:chicken_sandwich_8")
	public static final Item block = null;
	public ChickenSandwich8Item(SaModElements instance) {
		super(instance, 35);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(SAFoodItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(9).saturation(0.9f).build()));
			setRegistryName("chicken_sandwich_8");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Lettuce"));
