...
import net.mcreator.rpg.gui.PressGUIGuiWindow;
import net.mcreator.rpg.gui.PressGUIGui;
...
public class RPGItem extends SaModElements.ModElement {
	@ObjectHolder("sa:rpg")
	public static final Item block = null;
	public RPGItem(SaModElements instance) {
		super(instance, 42);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PressGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Simply Additions");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new PressGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
