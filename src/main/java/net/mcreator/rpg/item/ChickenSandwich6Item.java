...
public class ChickenSandwich6Item extends SaModElements.ModElement {
	@ObjectHolder("sa:chicken_sandwich_6")
	public static final Item block = null;
	public ChickenSandwich6Item(SaModElements instance) {
		super(instance, 33);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("chicken_sandwich_6");
		}
