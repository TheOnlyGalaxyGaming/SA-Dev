...
public class SlicedCheeseItem extends SaModElements.ModElement {
	@ObjectHolder("sa:sliced_cheese")
	public static final Item block = null;
	public SlicedCheeseItem(SaModElements instance) {
		super(instance, 41);
	}
