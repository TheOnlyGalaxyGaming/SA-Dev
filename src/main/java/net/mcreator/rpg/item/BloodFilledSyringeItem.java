...
public class BloodFilledSyringeItem extends SaModElements.ModElement {
	@ObjectHolder("sa:blood_filled_syringe")
	public static final Item block = null;
	public BloodFilledSyringeItem(SaModElements instance) {
		super(instance, 144);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("blood_filled_syringe");
		}
