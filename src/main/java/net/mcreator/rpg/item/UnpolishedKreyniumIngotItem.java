...
public class UnpolishedKreyniumIngotItem extends SaModElements.ModElement {
	@ObjectHolder("sa:unpolished_kreynium_ingot")
	public static final Item block = null;
	public UnpolishedKreyniumIngotItem(SaModElements instance) {
		super(instance, 11);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("unpolished_kreynium_ingot");
		}
