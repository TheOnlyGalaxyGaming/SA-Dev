...
public class ChickenSandwich5Item extends SaModElements.ModElement {
	@ObjectHolder("sa:chicken_sandwich_5")
	public static final Item block = null;
	public ChickenSandwich5Item(SaModElements instance) {
		super(instance, 32);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("chicken_sandwich_5");
		}
