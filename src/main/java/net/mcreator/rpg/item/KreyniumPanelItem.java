...
public class KreyniumPanelItem extends SaModElements.ModElement {
	@ObjectHolder("sa:kreynium_panel")
	public static final Item block = null;
	public KreyniumPanelItem(SaModElements instance) {
		super(instance, 17);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("kreynium_panel");
		}
