...
public class EmptyStymItem extends SaModElements.ModElement {
	@ObjectHolder("sa:empty_stym")
	public static final Item block = null;
	public EmptyStymItem(SaModElements instance) {
		super(instance, 140);
	}
