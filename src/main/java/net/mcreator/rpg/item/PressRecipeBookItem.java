...
import net.mcreator.rpg.procedures.PressRecipeBookItemInInventoryTickProcedure;
import net.mcreator.rpg.itemgroup.SAItemsItemGroup;
import net.mcreator.rpg.gui.PressRecipeBookGUIGuiWindow;
import net.mcreator.rpg.gui.PressRecipeBookGUIGui;
...
public class PressRecipeBookItem extends SaModElements.ModElement {
	@ObjectHolder("sa:press_recipe_book")
	public static final Item block = null;
	public PressRecipeBookItem(SaModElements instance) {
		super(instance, 27);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PressRecipeBookGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SAItemsItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("press_recipe_book");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Press Recipe Book");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new PressRecipeBookGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
		...
		public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
			...
			double z = entity.getPosZ();
			{
				...
				PressRecipeBookItemInInventoryTickProcedure.executeProcedure($_dependencies);
			}
		}
