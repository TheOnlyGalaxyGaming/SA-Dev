...
public class CreatureBoneItem extends SaModElements.ModElement {
	@ObjectHolder("sa:creature_bone")
	public static final Item block = null;
	public CreatureBoneItem(SaModElements instance) {
		super(instance, 153);
	}
