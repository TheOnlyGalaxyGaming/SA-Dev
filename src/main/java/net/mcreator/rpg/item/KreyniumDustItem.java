...
public class KreyniumDustItem extends SaModElements.ModElement {
	@ObjectHolder("sa:kreynium_dust")
	public static final Item block = null;
	public KreyniumDustItem(SaModElements instance) {
		super(instance, 10);
	}
