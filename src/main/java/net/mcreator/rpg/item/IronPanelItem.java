...
public class IronPanelItem extends SaModElements.ModElement {
	@ObjectHolder("sa:iron_panel")
	public static final Item block = null;
	public IronPanelItem(SaModElements instance) {
		super(instance, 16);
	}
