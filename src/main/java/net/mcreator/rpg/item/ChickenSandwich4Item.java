...
public class ChickenSandwich4Item extends SaModElements.ModElement {
	@ObjectHolder("sa:chicken_sandwich_4")
	public static final Item block = null;
	public ChickenSandwich4Item(SaModElements instance) {
		super(instance, 31);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("chicken_sandwich_4");
		}
