...
public class PurifiedBloodFilledSyringeItem extends SaModElements.ModElement {
	@ObjectHolder("sa:purified_blood_filled_syringe")
	public static final Item block = null;
	public PurifiedBloodFilledSyringeItem(SaModElements instance) {
		super(instance, 152);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("purified_blood_filled_syringe");
		}
